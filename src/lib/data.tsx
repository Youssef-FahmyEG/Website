...
export const PROJECTS: ProjectDetails[] = [
  ...
  },
  {
    ...
    description:'The dashboard provides a comprehensive analysis of hotel and resort performance, highlighting key operational metrics and offering actionable recommendations.
...
Total Special Requests: 61K
Bookings by Hotel Type:
City Hotel: 53K (61.13%)
Resort: 34K (38.87%)

Cancellation Rate by Month:
Highest: January (38.49%) and October (36.31%)
Lowest: March (18.40%)

Lead Time by Segment:
Groups: 148 days
Offline TA/TO: 106 days
Online TA: 80 days
Direct: 49 days
Corporate: 16 days
...
Cancellation Rate:
Analyze January and October customer feedback.
Implement flexible policies and monitor competitors’ promotions.
Assess cancellation trends between city and resort hotels.
  
Lead Time Optimization:
Automate bookings for Groups and Offline TA/TO.
Introduce early booking incentives to streamline planning.
Upsell short lead-time segments like Corporate and Direct.
Hotel Type Performance:

Promote Resort Hotels with seasonal offers and packages.
Leverage City Hotels' success through loyalty programs and corporate partnerships.
  
Market Segment Strategies:

Tailor group-specific offers and simplify the group booking process.
Strengthen relationships with Online/Offline TA/TO agents and enhance direct booking perks.
,
